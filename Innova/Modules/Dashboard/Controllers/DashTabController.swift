...
//        self.tabBar.layer.shadowOpacity = 0.5
    ...
    func setTabBarItems(){
        ...
        myTabBarItem0.image = UIImage(named: "houseUnselected")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem0.selectedImage = UIImage(named: "house")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem0.title = ""
        ...
        myTabBarItem1.image = UIImage(named: "calendarUnselected")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem1.selectedImage = UIImage(named: "calendar")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem1.title = ""
        ...
        myTabBarItem2.image = UIImage(named: "personUnselected")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem2.selectedImage = UIImage(named: "person")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem2.title = ""
